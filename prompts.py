STARTING_PROMPTS = [
    ...
    "Please generate the story, limit it to 100 words per response. Please format 1 response as a JSON in the form {\"message\": ..., \"playerHealthLost\": ... \"itemGained\": ...}. Do not return anything other than a JSON string."
]
